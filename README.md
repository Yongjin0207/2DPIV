...
![CI](https://github.com/Yongjin0207/2DPPI-Viewer/actions/workflows/ci.yml/badge.svg)
# 2DPPI-Viewer
...
--out OUTPUT.html
Output HTML file name (default: 2DPPIViewer.html)
...
python3 2DPPIViewer.py example.drw --out example.html 
...
2DPPIViewer requires DIMPLOT (LigPlot+) to generate `.drw` files.
...
If you use 2DPPIViewer in your research, please cite the associated publication or Zenodo record.
